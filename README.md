...
The marketing department  is looking to segment the company users by a number of different criteria.
...
I practice SQL queries to generate user lists for the marketing department.
